...
SINGLE_PARAM<-TRUE
SCALE_VARS<-FALSE
LAST_PART_PERCENTAGE <- 0.4 # Last percentage to be selected form the data...start 2000 till end 2015 -> 16 years
ratio_train<-0.8
ratio_test<-0.1
...
params <- expand.grid(
  ...
  nrounds=c(50,100,500,1000),          #-- Number of trees        
  max.depth=c(5,10,15),             #-- Maximum depth of the tree     
...
params <- expand.grid(
  ...
  colsample_bytree = c(0.8) ,    #-- Sample per tree
  subsample = c(0.5),
